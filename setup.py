...
setup(
    ...
    author_email = "rpa@seas.harvard.edu, jsnoek@seas.harvard.edu, kswersky@cs.toronto.edu, mgelbart@seas.harvard.edu, 
	hugo.larochelle@usherbrooke.ca, daniel.herandnez@uam.es, jmh@seas.harvard.edu",
